...
// Input 35
goog.provide('moclos.ui.DataAttribute');
goog.provide('moclos.ui.DataRole');


/**
 * @enum {string}
 */
moclos.ui.DataAttribute = {
    DATA_ROLE : 'data-role',
    DATA_INSET : 'data-inset'
};
...
// Input 36
goog.provide('moclos.ui.registry');

goog.require('moclos.ui.DataAttribute');
goog.require('goog.array');
goog.require('goog.dom');
...
/**
 *
 * @param dataRole {string}
 * @param decoratorFunction {Function}
 */
moclos.ui.registry.setDecoratorByDataRole = function (dataRole, decoratorFunction) {
    moclos.ui.registry.decoratorfuntionsByDataRoles_[dataRole] = decoratorFunction;
};
 ...
 * @param decoratorFunction {Function}
 */
moclos.ui.registry.setDecoratorByTagName = function (tagName, decoratorFunction) {
    moclos.ui.registry.decoratorfuntionsByTagNames_[tagName] = decoratorFunction;
};
 ...
 */
moclos.ui.registry.getDecorator = function (element) {
    if (element.hasAttribute(moclos.ui.DataAttribute.DATA_ROLE) &&
        (element.getAttribute(moclos.ui.DataAttribute.DATA_ROLE) in moclos.ui.registry.decoratorfuntionsByDataRoles_)) {
        return moclos.ui.registry.decoratorfuntionsByDataRoles_[element.getAttribute(moclos.ui.DataAttribute.DATA_ROLE)]();
    }
    if(element.tagName in moclos.ui.registry.decoratorfuntionsByTagNames_)  {
        return moclos.ui.registry.decoratorfuntionsByTagNames_[element.tagName];
    }
    return null;
};

/**
 * Decorates a root element and all its children recursively
 * @param rootElement {Element}
 * @return {goog.ui.Component}
 */
moclos.ui.registry.decorateTree = function(rootElement) {
    var decorator = moclos.ui.registry.getDecorator(rootElement);
    if(decorator !== null) {
        decorator.decorate(rootElement);
        goog.forEach(goog.dom.getChildren(rootElement), function(child) {
            var childDecorator = moclos.ui.registry.decorateTree(child);
            if (childDecorator !== null) {
                decorator.addChild(childDecorator, false);
            }
        });
    }
    return decorator;
 ...
 * @private
 */
moclos.ui.registry.decoratorfuntionsByDataRoles_ = {};

/**
 * @type {Object}
 * @private
 */
moclos.ui.registry.decoratorfuntionsByTagNames_ = {};

// Input 37
goog.provide('moclos.ui.Html');
 ...
 */
moclos.ui.Html = function(opt_domHelper) {
    goog.base(this, opt_domHelper);
};

goog.inherits(moclos.ui.Html, goog.ui.Component);

/**
 * @type {string}
 * @const
 */
moclos.ui.Html.CSS_CLASS_BASE = goog.getCssName('ui-mobile');

/**
 * @inheritDoc
 */
moclos.ui.Html.prototype.createDom = function() {
    var element = this.getDomHelper().createDom('body', moclos.ui.Html.CSS_CLASS_BASE);
 ...
 * @inheritDoc
 */
moclos.ui.Html.prototype.canDecorate = function(element) {
 ...
 * @inheritDoc
 */
moclos.ui.Html.prototype.decorateInternal = function(element) {
    goog.dom.classes.add(element, moclos.ui.Html.CSS_CLASS_BASE);
};

moclos.ui.registry.setDecoratorByTagName('BODY', function() {
    return new moclos.ui.Html(null);
});



// Input 38
goog.provide('moclos.ui.Body');

goog.require('goog.ui.Component');
goog.require('moclos.ui.registry');
 ...
 * @extends {goog.ui.Component}
 */
moclos.ui.Body = function(opt_domHelper) {
    goog.base(this, opt_domHelper);
};

goog.inherits(moclos.ui.Body, goog.ui.Component);

/**
 * @type {string}
 * @const
 */
moclos.ui.Body.CSS_CLASS_BASE = goog.getCssName('ui-mobile-viewport');

/**
 * @inheritDoc
 */
moclos.ui.Body.prototype.createDom = function() {
    var element = this.getDomHelper().createDom('body', moclos.ui.Body.CSS_CLASS_BASE);
    this.setElementInternal(element);
};
 ...
 * @inheritDoc
 */
moclos.ui.Body.prototype.canDecorate = function(element) {
 ...
 * @inheritDoc
 */
moclos.ui.Body.prototype.decorateInternal = function(element) {
    goog.dom.classes.add(element, moclos.ui.Body.CSS_CLASS_BASE);
};

moclos.ui.registry.setDecoratorByTagName('BODY', function() {
    return new moclos.ui.Body(null);
});



// Input 39
goog.provide('moclos.ui.Page');
 ...
 * @extends {goog.ui.Component}
 */
moclos.ui.Page = function(opt_domHelper) {
    goog.base(this, opt_domHelper);
...
goog.inherits(moclos.ui.Page, goog.ui.Component);

/**
 * @type {string}
 * @const
 */
moclos.ui.Page.CSS_CLASS_BASE = goog.getCssName('ui-page');

/**
 * @type {string}
 * @const
 */
moclos.ui.Page.CSS_CLASS_ACTIVE = goog.getCssName(moclos.ui.Page.CSS_CLASS_BASE,'active');

/**
 * @inheritDoc
 */
moclos.ui.Page.prototype.createDom = function() {
    var element = this.getDomHelper().createDom('div', moclos.ui.Page.CSS_CLASS_BASE);
    element.setAttribute(moclos.ui.DataAttribute.DATA_ROLE, moclos.ui.DataRole.PAGE);
    this.setElementInternal(element);
};
 ...
 * @inheritDoc
 */
moclos.ui.Page.prototype.canDecorate = function(element) {
    return element.hasAttribute(moclos.ui.DataAttribute.DATA_ROLE) &&
        element.getAttribute(moclos.ui.DataAttribute.DATA_ROLE) === moclos.ui.DataRole.PAGE;
};

/**
 * @inheritDoc
 */
moclos.ui.Page.prototype.decorateInternal = function(element) {
    var hasBaseClass = false;
    var classNames = goog.dom.classes.get(element);
    if (classNames) {
        goog.array.forEach(classNames, function(className) {
            if (className === moclos.ui.Page.CSS_CLASS_BASE) {
                hasBaseClass = true;
            } else if (className) {
                this.setStateFromClassName(className);
            }
        }, this);
    }

    if (!hasBaseClass) {
        goog.dom.classes.add(element, moclos.ui.Page.CSS_CLASS_BASE);
    }
};

moclos.ui.Page.prototype.setStateFromClassName = function(className) {
    this.active_ = className === goog.getCssName(moclos.ui.Page.CSS_CLASS_BASE, 'active');
};
 ...
 * @return {boolean}
 */
moclos.ui.Page.prototype.isActive = function() {
    return this.active_;
};
 ...
 */
moclos.ui.Page.prototype.setActive = function(active) {
    this.active_ = active;

    if(this.active_) {
        goog.dom.classes.add(this.getElement(), moclos.ui.Page.CSS_CLASS_ACTIVE);
    } else {
        goog.dom.classes.remove(this.getElement(), moclos.ui.Page.CSS_CLASS_ACTIVE);
    }
};

moclos.ui.registry.setDecoratorByDataRole(moclos.ui.DataRole.PAGE, function() {
    return new moclos.ui.Page(null);
});


// Input 40
goog.provide('moclos.main');
...
goog.require('moclos.ui.registry');
goog.require('moclos.ui.Html');
goog.require('moclos.ui.Body');
goog.require('moclos.ui.Page');


/**
 * @return {goog.ui.Component}
 */
moclos.main.initUI = function() {
    var htmlElement = goog.dom.getElementsByTagNameAndClass('HTML')[0];
    return moclos.ui.registry.decorateTree(htmlElement);
}

// Input 41
goog.provide('ze.mobile.start');

goog.require('moclos.main');
