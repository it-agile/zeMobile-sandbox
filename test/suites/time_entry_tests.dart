void timeEntryTests() {
  describe('A time entry based on a JSON string', () {
    ...
    it('shoult extract the start of time worked on the activity', () => expect(timeEntry.start).to(equal(new ZeTime(9, 0, 0))));
    it('shoult extract the end of time worked on the activity', () => expect(timeEntry.end).to(equal(new ZeTime(12, 0, 0))));
